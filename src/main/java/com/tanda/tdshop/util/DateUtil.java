...
public class DateUtil extends DateUtils {
    ...
    public static boolean isCurrentDayYMD(String dateStr) {
        ...
        String current = DateUtil.formatYMD(new Date());
    ...
    public static boolean isCurrentMonthYMD(String dateStr) {
        ...
        String queryDate = DateUtil.formatYM(DateUtil.parseYMD(dateStr));
        String current = DateUtil.formatYM(new Date());
    ...
    public static List<String> getiIntervalDate(String dateBegin, String dateEnd) {
        ...
        Date startDate = DateUtil.parseYMD(dateBegin);
        Date endDate = DateUtil.parseYMD(dateEnd);
        Calendar cal = Calendar.getInstance();
        cal.setTime(startDate);
        dateList.add(dateBegin);
        while (cal.getTime().compareTo(endDate) < 0) {
            cal.add(Calendar.DAY_OF_MONTH, 1);
            dateList.add(DateUtil.formatYMD(cal.getTime()));
        }
        return dateList;
    }
